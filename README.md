...
Este repositório contém a resolução da **Atividade 01** da disciplina de **Lógica de Programação e Algoritmos (LOPAL)**
...
2.  **Exercício :** Leitura de dois números e exibição da soma.
  <img width="292" height="508" alt="image" src="https://github.com/user-attachments/assets/02c7238b-9546-48d7-a8a9-7a9baf5614bb" />

3.  **Exercício :** Verificação de maioridade (maior ou igual a 18 anos).
  <img width="508" height="498" alt="image" src="https://github.com/user-attachments/assets/8bcc910f-5226-4f52-837d-b52f534c44db" />

4.  **Exercício :** Identificação de número positivo, negativo ou zero.
